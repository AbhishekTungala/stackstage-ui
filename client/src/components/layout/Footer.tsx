      ...
      <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-5 space-y-4">
              <Link to="/" className="group flex items-center space-x-3 w-fit">
                <div className="relative">
                  <div className="w-10 h-10 bg-gradient-to-br from-primary via-primary-glow to-purple-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-primary/25 transition-all duration-300">
                ...
                <div className="flex space-x-2">
                  {[
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-8 h-8 rounded-xl bg-muted/80 hover:bg-primary/10 border border-border/50 hover:border-primary/30 flex items-center justify-center text-muted-foreground hover:text-primary transition-all duration-300 group"
                      aria-label={label}
                    >
            ...
            {/* Navigation Sections - Reduced spacing */}
